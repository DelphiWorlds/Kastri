...
type
  ...
  TLocationChangeEvent = procedure(Sender: TObject; const Location: TLocationCoord2D; const Source: TLocationSource) of object;
...
uses
  ...
  // DW
  DW.OSLog, DW.Androidapi.JNI.Util,  DW.Androidapi.JNI.SupportV4, DW.Consts.Android, DW.OSDevice;
