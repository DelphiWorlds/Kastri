...
type
  ...
  JBaseProgram_Builder = interface(JObject)
    ...
    function setAudioLanguages(strings: TJavaObjectArray<JString>): JObject; cdecl;
    function setCanonicalGenres(strings: TJavaObjectArray<JString>): JObject; cdecl;
    function setContentRatings(tvcontentratings: TJavaObjectArray<JTvContentRating>): JObject; cdecl;
    function setDescription(string_1: JString): JObject; cdecl;
    function setEpisodeNumber(int: Integer): JObject; overload; cdecl;
    function setEpisodeNumber(string_1: JString; int: Integer): JObject; overload; cdecl;
    function setEpisodeTitle(string_1: JString): JObject; cdecl;
    function setId(long: Int64): JObject; cdecl;
    function setInternalProviderData(bytes: TJavaArray<Byte>): JObject; cdecl;
    function setInternalProviderFlag1(long: Int64): JObject; cdecl;
    function setInternalProviderFlag2(long: Int64): JObject; cdecl;
    function setInternalProviderFlag3(long: Int64): JObject; cdecl;
    function setInternalProviderFlag4(long: Int64): JObject; cdecl;
    function setLongDescription(string_1: JString): JObject; cdecl;
    function setPackageName(string_1: JString): JObject; cdecl;
    function setPosterArtUri(uri: Jnet_Uri): JObject; cdecl;
    function setReviewRating(string_1: JString): JObject; cdecl;
    function setReviewRatingStyle(int: Integer): JObject; cdecl;
    function setSearchable(boolean: Boolean): JObject; cdecl;
    function setSeasonNumber(int: Integer): JObject; overload; cdecl;
    function setSeasonNumber(string_1: JString; int: Integer): JObject; overload; cdecl;
    function setSeasonTitle(string_1: JString): JObject; cdecl;
    function setThumbnailUri(uri: Jnet_Uri): JObject; cdecl;
    function setTitle(string_1: JString): JObject; cdecl;
    function setVideoHeight(int: Integer): JObject; cdecl;
    function setVideoWidth(int: Integer): JObject; cdecl;
  end;
  ...
  JBasePreviewProgram_Builder = interface(JBaseProgram_Builder)
    ...
    function setAuthor(string_1: JString): JObject; cdecl;
    function setAvailability(int: Integer): JObject; cdecl;
    function setBrowsable(boolean: Boolean): JObject; cdecl;
    function setContentId(string_1: JString): JObject; cdecl;
    function setDurationMillis(int: Integer): JObject; cdecl;
    function setEndTimeUtcMillis(long: Int64): JObject; cdecl;
    function setGenre(string_1: JString): JObject; cdecl;
    function setIntent(intent: JIntent): JObject; cdecl;
    function setIntentUri(uri: Jnet_Uri): JObject; cdecl;
    function setInteractionCount(long: Int64): JObject; cdecl;
    function setInteractionType(int: Integer): JObject; cdecl;
    function setInternalProviderId(string_1: JString): JObject; cdecl;
    function setItemCount(int: Integer): JObject; cdecl;
    function setLastPlaybackPositionMillis(int: Integer): JObject; cdecl;
    function setLive(boolean: Boolean): JObject; cdecl;
    function setLogoContentDescription(string_1: JString): JObject; cdecl;
    function setLogoUri(uri: Jnet_Uri): JObject; cdecl;
    function setOfferPrice(string_1: JString): JObject; cdecl;
    function setPosterArtAspectRatio(int: Integer): JObject; cdecl;
    function setPreviewAudioUri(uri: Jnet_Uri): JObject; cdecl;
    function setPreviewVideoUri(uri: Jnet_Uri): JObject; cdecl;
    function setReleaseDate(date: JDate): JObject; overload; cdecl;
    function setReleaseDate(string_1: JString): JObject; overload; cdecl;
    function setStartTimeUtcMillis(long: Int64): JObject; cdecl;
    function setStartingPrice(string_1: JString): JObject; cdecl;
    function setThumbnailAspectRatio(int: Integer): JObject; cdecl;
    function setTransient(boolean: Boolean): JObject; cdecl;
    function setTvSeriesItemType(int: Integer): JObject; cdecl;
    function setType(int: Integer): JObject; cdecl;
  end;
