...
type
  ...
  JDWMultiBroadcastReceiverClass = interface(JBroadcastReceiverClass)
    ...
    {class} function _GetACTION_NOTIFICATION_ACTION: JString; cdecl;
    {class} function _GetACTION_SERVICE_ALARM: JString; cdecl;
    {class} function _GetEXTRA_NOTIFICATION: JString; cdecl;
    {class} function _GetEXTRA_NOTIFICATION_ACTION_NAME: JString; cdecl;
    ...
    {class} property ACTION_NOTIFICATION_ACTION: JString read _GetACTION_NOTIFICATION_ACTION;
    ...
    {class} property EXTRA_NOTIFICATION_ACTION_NAME: JString read _GetEXTRA_NOTIFICATION_ACTION_NAME;
